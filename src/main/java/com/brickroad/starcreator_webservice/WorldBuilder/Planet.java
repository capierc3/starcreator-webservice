...
public class Planet extends Body {
    ...
    private void findSize(){
        ...
        if (planetSize <= 1){
            ...
            size = "Large";
            circumference = Dice.Roller(10,10)* 2L;
        } else if (planetSize == 8){
            size = "Huge";
            circumference = Dice.Roller(10,10)* 3L;
        } else if (planetSize == 9){
            size = "Enormous";
            circumference = Dice.Roller(10,10)* 4L;
        } else {
            size = "Massive";
            circumference = Dice.Roller(10,10)* 5L;
        }
    }
    ...
    public String getAtmoThickness() {
        return atmoThickness;
    }

    public double getAtmoRating() {
        return atmoRating;
    }
