...
/**
 * Enum representing minerals and compounds that make up planetary composition.
 * Each mineral has a density range used for validation against planet density.
 */
