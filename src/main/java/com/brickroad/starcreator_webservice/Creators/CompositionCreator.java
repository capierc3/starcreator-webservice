...
import com.brickroad.starcreator_webservice.model.compositions.CompositionTemplateComponentRef;
...
import com.brickroad.starcreator_webservice.repos.CompositionTemplateRefRepository;
...
public class CompositionCreator {
    ...
    private PlanetaryComposition createDefaultComposition(String coreType, String planetType) {
        ...
        // Determine classification and composition based on planet/core type
