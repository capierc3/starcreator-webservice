-- =====================================================================
-- Flyway Migration V9: Planet Generation System
-- =====================================================================
-- Description: Adds comprehensive planet generation capabilities
--              including planet entities and reference data for
--              18 distinct planet types with realistic astrophysical
--              parameters.
-- Author:
-- Date: 2025-01-18
-- =====================================================================
...
CREATE TABLE IF NOT EXISTS ud.planet (
    ...
    -- Basic Properties (inherited from CelestialBody pattern)
...
-- Index for orbital position ordering
CREATE INDEX IF NOT EXISTS idx_planet_orbital_position 
ON ud.planet(star_id, orbital_position);
...
CREATE INDEX IF NOT EXISTS idx_planet_created_at 
ON ud.planet(created_at);
...
(
    'Hot Rocky Planet', 
    'Small rocky planet very close to its star, extremely hot with little to no atmosphere', 
    0.05, 0.4, 
    0.3, 0.6, 
    5.4, 
    0.05, 0.4, 
...
(
    'Terrestrial Planet', 
    'Rocky planet with potential for atmosphere and liquid water', 
    0.5, 2.0, 
    0.7, 1.3, 
    5.5, 
    0.7, 1.5, 
    true, 'N2, O2, trace gases', 
    false, 0.0, 
    0, 2, 
    true, 0.3, 'Iron-Nickel', 
    200, 'habitable'
),
...
(
    'Super-Earth', 
    'Large rocky planet with high gravity, can retain thick atmosphere', 
    2.0, 10.0, 
    1.3, 2.0, 
    5.0, 
    0.5, 2.0, 
    true, 'N2, CO2, H2O vapor', 
    false, 0.0, 
    0, 4, 
    true, 0.35, 'Iron-Silicate', 
    180, 'habitable'
),
...
(
    'Desert Planet', 
    'Rocky world with minimal water, thin atmosphere', 
    0.4, 1.5, 
    0.6, 1.2, 
    5.2, 
    0.8, 2.0, 
    true, 'CO2, N2, trace H2O', 
    false, 0.0, 
    0, 2, 
    false, 0.25, 'Iron-Nickel', 
    120, 'inner'
),
...
(
    'Ocean Planet', 
    'Water-rich world with deep global oceans', 
    0.8, 3.0, 
    0.9, 1.5, 
    4.0, 
    0.9, 1.8, 
    true, 'H2O vapor, N2, O2', 
    false, 0.0, 
    0, 3, 
    true, 0.4, 'Silicate-Water', 
    100, 'habitable'
),
...
(
    'Lava Planet', 
    'Extremely hot world with molten surface due to tidal heating or proximity to star', 
    0.5, 2.0, 
    0.7, 1.2, 
    5.5, 
    0.01, 0.15, 
...
(
    'Mini-Neptune', 
    'Small gas planet with thick hydrogen-helium atmosphere over rocky core', 
    2.0, 10.0, 
    1.5, 3.0, 
    2.5, 
    0.5, 5.0, 
...
(
    'Sub-Neptune', 
    'Neptune-sized planet with substantial atmosphere', 
    10.0, 20.0, 
    2.5, 4.0, 
    1.8, 
    1.0, 10.0, 
...
(
    ...
    0.7, 
    0.01, 0.1, 
    true, 'H2, He, hot metals', 
    true, 0.1, 
    0, 2, 
    false, 0.15, 'Diffuse Gas', 
    100, 'inner'
),
...
(
    'Gas Giant', 
    'Large planet composed primarily of hydrogen and helium', 
    100.0, 400.0, 
    9.0, 12.0, 
    1.3, 
    3.0, 10.0, 
    ...
    true, 0.4, 
    10, 80, 
    false, 0.5, 'Diffuse Gas-Metallic H', 
    300, 'outer'
),
...
(
    'Super-Jupiter', 
    'Extremely massive gas giant', 
    400.0, 3000.0, 
    12.0, 20.0, 
    1.8, 
    5.0, 30.0, 
    true, 'H2, He, exotic compounds', 
    true, 0.5, 
    20, 100, 
    false, 0.45, 'Metallic Hydrogen', 
    80, 'outer'
);
...
(
    'Ice Giant', 
    'Planet composed of water, methane, and ammonia ices with small rocky core', 
    10.0, 25.0, 
    3.5, 5.0, 
    1.6, 
    8.0, 30.0, 
    true, 'H2, He, CH4, NH3, H2O', 
    true, 0.4, 
    5, 30, 
    false, 0.6, 'Ice-Rock', 
    220, 'outer'
...
(
    'Puffy Planet', 
    'Low-density gas giant with inflated atmosphere due to stellar heating', 
    50.0, 300.0, 
    10.0, 18.0, 
    0.4, 
    0.02, 0.15, 
    true, 'H2, He, hot volatiles', 
    true, 0.15, 
    0, 3, 
    false, 0.2, 'Diffuse Gas', 
    70, 'inner'
);
...
(
    'Carbon Planet', 
    'Rocky planet rich in carbon compounds, graphite, and possibly diamonds', 
    0.5, 5.0, 
    0.7, 1.8, 
    6.0, 
    0.5, 3.0, 
...
(
    'Iron Planet', 
    'Stripped rocky core, primarily metallic composition', 
    0.1, 1.0, 
    0.4, 0.8, 
    8.0, 
    0.1, 0.5, 
...
(
    'Ice World', 
    'Frozen planet beyond the frost line, covered in water and methane ice', 
    0.1, 5.0, 
    0.5, 2.0, 
    2.0, 
    5.0, 50.0, 
...
(
    'Dwarf Planet', 
    'Small planetary body, often icy, in outer system', 
    0.001, 0.1, 
    0.1, 0.5, 
    2.5, 
    10.0, 100.0, 
    true, 'N2, CH4, CO (trace)', 
    false, 0.0, 
    0, 5, 
    false, 0.6, 'Ice-Rock', 
    100, 'outer'
...
(
    'Rogue Planet', 
    'Planet ejected from star system or formed independently', 
    0.5, 10.0, 
    0.8, 3.0, 
    4.0, 
    0.0, 0.0, 
    true, 'H2, He, frozen volatiles', 
    false, 0.0, 
    0, 5, 
    false, 0.05, 'Rocky-Ice', 
    30, NULL
);
...
'Stores generated planet data with comprehensive astrophysical properties';
...
'Foreign key to parent star - CASCADE delete ensures planets are removed with their star';

COMMENT ON COLUMN ud.planet.semi_major_axis_au IS 
'Average orbital distance from parent star in Astronomical Units';

COMMENT ON COLUMN ud.planet.habitable_zone_position IS 
'Position relative to habitable zone: too_hot, inner_edge, habitable_zone, outer_edge, too_cold';

COMMENT ON COLUMN ref.planet_type_ref.formation_zone IS 
'Preferred formation location: inner (hot), habitable, frost_line, outer (cold)';

COMMENT ON COLUMN ref.planet_type_ref.rarity_weight IS 
'Weighted probability for random generation - higher values are more common';

-- =====================================================================
-- SECTION 6: Grant Permissions (Adjust as needed for your setup)
-- =====================================================================

-- Grant SELECT on reference table to application user
-- GRANT SELECT ON ref.planet_type_ref TO your_app_user;

-- Grant all operations on planet table to application user
-- GRANT SELECT, INSERT, UPDATE, DELETE ON ud.planet TO your_app_user;
-- GRANT USAGE, SELECT ON SEQUENCE ud.planet_id_seq TO your_app_user;

-- =====================================================================
-- SECTION 7: Verify Migration
-- =====================================================================

-- Verify planet type count
DO $$
DECLARE
    type_count INTEGER;
BEGIN
...
SELECT 
    'MIGRATION V9 SUMMARY' as status,
    (SELECT COUNT(*) FROM ref.planet_type_ref) as planet_types_loaded,
    (SELECT COUNT(*) FROM ref.planet_type_ref WHERE habitable = TRUE) as habitable_types,
    (SELECT COUNT(*) FROM ref.planet_type_ref WHERE can_have_rings = TRUE) as ring_capable_types,
    (SELECT SUM(rarity_weight) FROM ref.planet_type_ref) as total_rarity_weight;
