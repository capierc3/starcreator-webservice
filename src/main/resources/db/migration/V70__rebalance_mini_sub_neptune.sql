...
--   - Set rarity weight to 110 — LOW because NULL zone means it's
--     eligible everywhere. Zone-restricted types need high weights to
--     compensate for limited eligibility; zone-unrestricted types get
--     picked constantly even at modest weights. Target: ~8-15%.
...
-- Weight intentionally low (110) because NULL zone = eligible everywhere
